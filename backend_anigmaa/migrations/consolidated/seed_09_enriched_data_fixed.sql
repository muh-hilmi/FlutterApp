-- ============================================================================
-- SEED 09: ENRICHED DUMMY DATA (FIXED VERSION)
-- ============================================================================
-- This script adds:
...
-- ============================================================================
-- Update users with more realistic details (phone, social media, bio, etc.)
...
UPDATE events e SET attendees_count = (
    ...
    WHERE ea.event_id::text = e.id::text AND ea.status = 'confirmed')
WHERE e.id IN (SELECT id FROM events WHERE host_id IN (SELECT id FROM users WHERE email LIKE '%anigmaa.com'));

-- ============================================================================
-- SUMMARY
-- ============================================================================
-- Updated user profiles with phone, location, bio
